  ...
  return (
    <section id="contact" className="mx-auto max-w-6xl px-4 py-12 md:py-20 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
        ...
        >
          {/* Availability Card */}
          <div className="glass-panel p-6 md:p-8 rounded-2xl relative group hover-glow-emerald overflow-hidden hover:border-white/20 transition-all shadow-lg hover:shadow-white/5">
        ...
        >
          <div className="glass-panel p-6 md:p-10 rounded-2xl relative group hover-glow-white overflow-hidden min-h-[500px] flex flex-col justify-center shadow-lg hover:border-white/20 transition-colors duration-300">
            <div className="card-glow-overlay pointer-events-none absolute -inset-px rounded-2xl opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
